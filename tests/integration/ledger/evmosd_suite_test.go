...
import (
	...
	"github.com/gurufin2021/GURUx/tests/integration/ledger/mocks"
	...
	clientkeys "github.com/gurufin2021/GURUx/client/keys"
...
func (suite *LedgerTestSuite) SetupGuruxApp() {
...
func (suite *LedgerTestSuite) guruxAddKeyCmd() *cobra.Command {
...
func (suite *LedgerTestSuite) MockKeyringOption() keyring.Option {
	return func(options *keyring.Options) {
		options.SupportedAlgos = gurukr.SupportedAlgorithms
		options.SupportedAlgosLedger = gurukr.SupportedAlgorithmsLedger
		options.LedgerDerivation = func() (cosmosledger.SECP256K1, error) { return suite.ledger, nil }
		options.LedgerCreateKey = gurukr.CreatePubkey
		options.LedgerAppName = gurukr.AppName
		options.LedgerSigSkipDERConv = gurukr.SkipDERConversion
	}
}
