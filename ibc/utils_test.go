...
func init() {
	cfg := sdk.GetConfig()
	cfg.SetBech32PrefixForAccount("gurux", "guruxpub")
}
...
func TestGetTransferSenderRecipient(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "cosmos1",
						Receiver: "gurux1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
						Amount:   "123456",
					},
				),
			},
		...
		{
			"valid - cosmos sender, gurux recipient",
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "cosmos1qql8ag4cluz6r4dz28p3w00dnc9w8ueulg2gmc",
			...
			"gurux1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			"gurux1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
			false,
		},
		{
			"valid - gurux sender, cosmos recipient",
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
		...
		{
			"valid - osmosis sender, gurux recipient",
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
...
func TestGetReceivedCoin(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"transfer",
			"channel-0",
			"transfer/channel-0/agurux",
			"10",
			sdk.Coin{Denom: "agurux", Amount: sdk.NewInt(10)},
		},
		{
...
func TestGetSentCoin(t *testing.T) {
	testCases := []struct {
		...
		{
			"get unwrapped agurux coin",
			"agurux",
			"10",
			sdk.Coin{Denom: "agurux", Amount: sdk.NewInt(10)},
		},
		{
			"get ibc wrapped agurux coin",
			"transfer/channel-0/agurux",
			"10",
			sdk.Coin{Denom: teststypes.AguruxIbcdenom, Amount: sdk.NewInt(10)},
		},
		{
