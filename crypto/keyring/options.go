...
// AppName defines the Ledger app used for signing. Gurux uses the Ethereum app
...
var (
	...
	// LedgerDerivation defines the Gurux Ledger Go derivation (Ethereum app with EIP-712 signing)
