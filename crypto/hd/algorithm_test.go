...
import (
	...
	cryptocodec "github.com/gurufin2021/GURUx/crypto/codec"
	enccodec "github.com/gurufin2021/GURUx/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("gurux", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
...
func TestDerivation(t *testing.T) {
	...
	path := hdwallet.MustParseDerivationPath(gurutypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of Gurux implementation
	...
	// Equality of Eth and Gurux implementation
	...
	// Inequality of wrong derivation path of Eth and Gurux implementation
