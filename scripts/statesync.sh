...
# Initialize chain.
guruxd init test --chain-id gurux_9000-2

# Get Genesis
wget https://archive.gurux.org/mainnet/genesis.json
mv genesis.json ~/.guruxd/config/

wget -O ~/.guruxd/config/adrbook.json https://snapshot.notional.ventures/gurux/addrbook.json
...
export GURUXD_P2P_MAX_NUM_INBOUND_PEERS=200
export GURUXD_P2P_MAX_NUM_OUTBOUND_PEERS=200
export GURUXD_STATESYNC_RPC_SERVERS="https://gurux-rpc.polkachu.com:443,https://rpc-gurux-ia.notional.ventures:443"
