...
const (
	// Amino names
	cancelRevenueName   = "gurux/MsgCancelRevenue"
	registerRevenueName = "gurux/MsgRegisterRevenue"
	updateRevenueName   = "gurux/MsgUpdateRevenue"
	updateParamsName    = "gurux/MsgUpdateParams"
)
