...
const (
	// Amino names
	clawback                     = "gurux/MsgClawback"
	createClawbackVestingAccount = "gurux/MsgCreateClawbackVestingAccount"
	updateVestingFunder          = "gurux/MsgUpdateVestingFunder"
	convertVestingAccount        = "gurux/MsgConvertVestingAccount"
)
