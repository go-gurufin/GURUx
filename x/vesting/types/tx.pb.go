...
// source: gurux/vesting/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateClawbackVestingAccount)(nil), "gurux.vesting.v1.MsgCreateClawbackVestingAccount")
	proto.RegisterType((*MsgCreateClawbackVestingAccountResponse)(nil), "gurux.vesting.v1.MsgCreateClawbackVestingAccountResponse")
	proto.RegisterType((*MsgClawback)(nil), "gurux.vesting.v1.MsgClawback")
	proto.RegisterType((*MsgClawbackResponse)(nil), "gurux.vesting.v1.MsgClawbackResponse")
	proto.RegisterType((*MsgUpdateVestingFunder)(nil), "gurux.vesting.v1.MsgUpdateVestingFunder")
	proto.RegisterType((*MsgUpdateVestingFunderResponse)(nil), "gurux.vesting.v1.MsgUpdateVestingFunderResponse")
	proto.RegisterType((*MsgConvertVestingAccount)(nil), "gurux.vesting.v1.MsgConvertVestingAccount")
	proto.RegisterType((*MsgConvertVestingAccountResponse)(nil), "gurux.vesting.v1.MsgConvertVestingAccountResponse")
}

func init() { proto.RegisterFile("gurux/vesting/v1/tx.proto", fileDescriptor_d5db113bc0c7240c) }
...
var fileDescriptor_d5db113bc0c7240c = []byte{
	...
	0xdc, 0x7d, 0x28, 0x32, 0xca, 0xbc, 0xf5, 0xba, 0x75, 0x70, 0xf1, 0x22, 0xec, 0x8c, 0xf2, 0x7f,
	0x8c, 0x3b, 0xbf, 0x02, 0x00, 0x00, 0xff, 0xff, 0x47, 0x37, 0xbd, 0xee, 0x64, 0x07, 0x00, 0x00,
}
...
func (c *msgClient) CreateClawbackVestingAccount(ctx context.Context, in *MsgCreateClawbackVestingAccount, opts ...grpc.CallOption) (*MsgCreateClawbackVestingAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gurux.vesting.v1.Msg/CreateClawbackVestingAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Clawback(ctx context.Context, in *MsgClawback, opts ...grpc.CallOption) (*MsgClawbackResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gurux.vesting.v1.Msg/Clawback", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateVestingFunder(ctx context.Context, in *MsgUpdateVestingFunder, opts ...grpc.CallOption) (*MsgUpdateVestingFunderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gurux.vesting.v1.Msg/UpdateVestingFunder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ConvertVestingAccount(ctx context.Context, in *MsgConvertVestingAccount, opts ...grpc.CallOption) (*MsgConvertVestingAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gurux.vesting.v1.Msg/ConvertVestingAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateClawbackVestingAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gurux.vesting.v1.Msg/CreateClawbackVestingAccount",
	}
...
func _Msg_Clawback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gurux.vesting.v1.Msg/Clawback",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateVestingFunder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gurux.vesting.v1.Msg/UpdateVestingFunder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ConvertVestingAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gurux.vesting.v1.Msg/ConvertVestingAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gurux.vesting.v1.Msg",
	...
	Metadata: "gurux/vesting/v1/tx.proto",
}
