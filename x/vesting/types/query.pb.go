...
// source: gurux/vesting/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryBalancesRequest)(nil), "gurux.vesting.v1.QueryBalancesRequest")
	proto.RegisterType((*QueryBalancesResponse)(nil), "gurux.vesting.v1.QueryBalancesResponse")
}

func init() { proto.RegisterFile("gurux/vesting/v1/query.proto", fileDescriptor_ff0457b141ab5d28) }
...
var fileDescriptor_ff0457b141ab5d28 = []byte{
	...
	0x9c, 0x49, 0xf3, 0x39, 0x0e, 0xbd, 0xd8, 0xb0, 0x66, 0x4a, 0xdd, 0x52, 0x76, 0x61, 0x47, 0x6f,
	0x01, 0x00, 0x00, 0xff, 0xff, 0xe7, 0xf5, 0x1e, 0xa2, 0xe7, 0x02, 0x00, 0x00,
}
...
func (c *queryClient) Balances(ctx context.Context, in *QueryBalancesRequest, opts ...grpc.CallOption) (*QueryBalancesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gurux.vesting.v1.Query/Balances", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Balances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gurux.vesting.v1.Query/Balances",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gurux.vesting.v1.Query",
	...
	Metadata: "gurux/vesting/v1/query.proto",
}
