...
// registered via governance. Note that the native staking denomination (e.g. "agurux"),
...
func (k Keeper) ConvertCoinToERC20FromPacket(ctx sdk.Context, data transfertypes.FungibleTokenPacketData) error {
	...
	// assume that all module accounts on Gurux need to have their tokens in the
