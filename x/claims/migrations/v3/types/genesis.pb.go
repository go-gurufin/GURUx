...
// source: gurux/claims/v1/genesis.proto
...
func init() {
	proto.RegisterType((*V3GenesisState)(nil), "gurux.claims.v1.V3GenesisState")
	proto.RegisterType((*V3Params)(nil), "gurux.claims.v1.V3Params")
}

func init() { proto.RegisterFile("gurux/claims/v1/genesis.proto", fileDescriptor_f2f8f1d6f18af278) }
