...
// The initial InflationDistribution can be calculated from the Gurux Token
// Model like this:
...
func init() {
	proto.RegisterType((*InflationDistribution)(nil), "gurux.inflation.v1.InflationDistribution")
	proto.RegisterType((*ExponentialCalculation)(nil), "gurux.inflation.v1.ExponentialCalculation")
}
