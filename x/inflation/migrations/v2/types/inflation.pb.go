...
// source: gurux/inflation/v1/inflation.proto
...
// The initial V2InflationDistribution can be calculated from the Gurux Token
// Model like this:
...
func init() {
	proto.RegisterType((*V2InflationDistribution)(nil), "gurux.inflation.v1.V2InflationDistribution")
	proto.RegisterType((*V2ExponentialCalculation)(nil), "gurux.inflation.v1.V2ExponentialCalculation")
}

func init() {
	proto.RegisterFile("gurux/inflation/v1/inflation.proto", fileDescriptor_d064cb35c3ff7df8)
}
